...
import com.wangsheng.sharecampus.activity.BigshotActivity;
...
public class BigshotRecyclerAdapter {
    private List<HashMap<String,Object>> mData;
    private Context mContext;
    public BigshotRecyclerAdapter(List<HashMap<String,Object>> mData, Context mContext){
        this.mData = mData;
    ...
    public CommonAdapter getAdapter(){
        return new CommonAdapter<HashMap<String,Object>>(mContext, R.layout.item_recy_bigshot_v,mData) {
            @Override
