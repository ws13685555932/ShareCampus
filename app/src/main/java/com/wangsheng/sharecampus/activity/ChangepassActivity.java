...
public class ChangepassActivity extends AppCompatActivity {
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.register_bu_getcode:
                ...
                Toast.makeText(ChangepassActivity.this, "注意查收"+phonenum, Toast.LENGTH_SHORT).show();
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                switch (resultcode) {
                                    ...
                                    default:
                                        Looper.prepare();
                                        Toast.makeText(ChangepassActivity.this, "验证码错误"+result, Toast.LENGTH_SHORT).show();
                                        Looper.loop();
                                        break;
                                }
    ...
    private void registerIn(final String phone,final String password){
        ...
        userChangepassRequest.setUserName(phone);
        userChangepassRequest.setNewPass(password);
        Observable<ResponseInfo<UserChangepassResponse>> call = userService.changePass(userChangepassRequest);
        call.compose(RxSchedulersHelper.<ResponseInfo<UserChangepassResponse>>io_main())
                .subscribe(new HttpObserver<UserChangepassResponse>() {
                    @Override
                    public void onSuccess(UserChangepassResponse userLogin) {
