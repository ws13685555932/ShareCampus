package com.wangsheng.sharecampus.activity.editinfo;
...
public class EditInfoActivity extends AppCompatActivity{
    ...
    private void editUser(final TextView v,final String content){
        ...
        editInfoBean.setRealname(user_realname.getText().toString());
        if(user_sex.getText().toString().equals("男")){
            editInfoBean.setGender(1);
        }else{
            editInfoBean.setGender(0);
        }
        editInfoBean.setInfo(user_introduction.getText().toString());
        editInfoBean.setUserName(SharedUtil.getParam("userName","").toString());
        Observable<ResponseInfo<EditInfoBean>> call = userService.edit(editInfoBean);
        call.compose(RxSchedulersHelper.<ResponseInfo<EditInfoBean>>io_main())
                .subscribe(new HttpObserver<EditInfoBean>() {
                    @Override
    ...
    private void getInfo(final String phone){
//        UserService userService = HttpManager.getInstance().createService(UserService.class);
//        infoBean infobean = new infoBean();
//        infobean.setUserName(phone);
//        Observable<ResponseInfoString> call = userService.info(infobean);
//        call.compose(RxSchedulersHelper.<ResponseInfoString>io_main())
//                .subscribe(new HttpObserverString() {
//                    @Override
//                    public void onSuccess(JSONObject user) {
//                        try {
//                            JSONObject jsonObject = user;
//                            //JSONObject jsonObject = new JSONObject(user).getJSONObject("user");
//                            if(jsonObject.getString("gender").equals("1")){
//                                user_sex.setText("男");
//                            }else{
//                                user_sex.setText("女");
//                            }
//                            user_realname.setText(jsonObject.getString("realname"));
//                            user_introduction.setText(jsonObject.getString("info"));
//
