package com.wangsheng.sharecampus.activity.register;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerIn(final String phone,final String password){
        ...
        registerBean.setUserPass(password);
        Observable<ResponseInfo<RegisterBean>> call = userService.register(registerBean);
        call.compose(RxSchedulersHelper.<ResponseInfo<RegisterBean>>io_main())
                .subscribe(new HttpObserver<RegisterBean>() {
                    @Override
                    public void onSuccess(RegisterBean userLogin) {
