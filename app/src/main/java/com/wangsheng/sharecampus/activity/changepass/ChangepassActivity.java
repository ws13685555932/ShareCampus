package com.wangsheng.sharecampus.activity.changepass;
...
public class ChangepassActivity extends AppCompatActivity {
    ...
    private void registerIn(final String phone,final String password){
        ...
        changepassBean.setUserName(phone);
        changepassBean.setNewPass(password);
        Observable<ResponseInfo<ChangepassBean>> call = userService.changePass(changepassBean);
        call.compose(RxSchedulersHelper.<ResponseInfo<ChangepassBean>>io_main())
                .subscribe(new HttpObserver<ChangepassBean>() {
                    @Override
                    public void onSuccess(ChangepassBean userLogin) {
